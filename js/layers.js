...
addLayer("t", {
        ...
        color: "#006609",
        requires() { return new Decimal(1).times(Decimal.pow("1", Decimal.pow(player[this.layer].unlockOrder, 1.415038))) }, // Can be a function that takes requirement increases into account
